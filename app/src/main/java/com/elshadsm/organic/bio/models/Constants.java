...
public class Constants {
    ...
    public static final String PRODUCT_EXTRA_NAME = "product";
    public static final String USER_PREF_NAME = "private_user_preference";
    ...
    public static final String USER_EMAIL_PREF_NAME = "user_email_preference";
    public static final String USER_COUNTRY_PREF_NAME = "user_country_preference";
    public static final String USER_CITY_PREF_NAME = "user_city_preference";
